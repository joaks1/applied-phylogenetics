...
\step{Define Markov-chain models of substitution}{
    ...
    \begin{figure}[htbp]
        \centering
        \fbox{\includegraphics[width=0.8\textwidth]{../screenshots/beauti-cytb-model.jpg}}
...
\step{Define clock models.}{
    ...
    branch rates across the tree. BEAUTi provides four options for clock
    models:
    \begin{compactdesc}
        ...
        \item[\fieldvalue{Exponential relaxed clock (Uncorrelated)}]  Assumes that
            ...
            \citep{Drummond2006}.
        \item[\field{Random local clock}] Uses Bayesian stochastic search

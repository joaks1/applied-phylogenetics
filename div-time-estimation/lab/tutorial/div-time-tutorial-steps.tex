...
\step{Download the data and other files from Google Drive.}{
    Download the \localfile{div-time-tutorial.zip} archive from the Google Drive
    folder to your desktop, and unzip the archive.
...
\step{Look at the summary tree in \program{FigTree}.}{
    Launch the \program{FigTree} program, and load the \localfile{crocodylia-MCC.tree} file
...
\step{Inspect the results of your short analysis with \program{Tracer}.}{
    ...
    prior on \fieldvalue{ucld.stdev}. Approximately how different are the
